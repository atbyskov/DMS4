...
# Bounds
column_diameter_bounds = (30.0, 100) # Column Diameter Bounds [mm]
column_thickness_bounds = (1, 10.0)   # Column Thickness Bounds [mm]
brace_diameter_bounds = (10, 100.0)   # Brace Diameter Bounds [mm]
brace_thickness_bounds = (0.1, 10.0)    # Brace Thickness Bounds [mm]
